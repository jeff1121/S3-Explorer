              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  style: ButtonStyle(
                    ...
                    backgroundColor:
                        WidgetStateProperty.all<Color>(NowUIColors.defaultColor),
                  ),
                  onPressed: () {
                ...
                child: Padding(
                  ...
                  child: ElevatedButton(
                    style: ButtonStyle(
                      ...
                      backgroundColor:
                          WidgetStateProperty.all<Color>(NowUIColors.primary),
                    ),
                    onPressed: () {
                      // Respond to button press
                      Navigator.pushReplacementNamed(context, '/home');
                ...
                child: Padding(
                  ...
                  child: ElevatedButton(
                    style: ButtonStyle(
                      ...
                      backgroundColor:
                          WidgetStateProperty.all<Color>(NowUIColors.info),
                    ),
                    onPressed: () {
                      // Respond to button press
                      Navigator.pushReplacementNamed(context, '/home');
                ...
                child: Padding(
                  ...
                  child: ElevatedButton(
                    style: ButtonStyle(
                      ...
                      backgroundColor:
                          WidgetStateProperty.all<Color>(NowUIColors.success),
                    ),
                    onPressed: () {
                      // Respond to button press
                      Navigator.pushReplacementNamed(context, '/home');
                ...
                child: Padding(
                  ...
                  child: ElevatedButton(
                    style: ButtonStyle(
                      ...
                      backgroundColor:
                          WidgetStateProperty.all<Color>(NowUIColors.warning),
                    ),
                    onPressed: () {
                      // Respond to button press
                      Navigator.pushReplacementNamed(context, '/home');
                ...
                child: Padding(
                  ...
                  child: ElevatedButton(
                    style: ButtonStyle(
                      ...
                      backgroundColor:
                          WidgetStateProperty.all<Color>(NowUIColors.error),
                    ),
                    onPressed: () {
                      // Respond to button press
                      Navigator.pushReplacementNamed(context, '/home');
